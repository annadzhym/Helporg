(function ($) {
    ...
    jQuery(document).on("ready", function () {
        ...
        $(".home-slides").owlCarousel({ loop: true, nav: true, dots: false, autoplayHoverPause: true, autoplay: true, items: 1, navText: ["<i class='icofont-rounded-left'></i>", "<i class='icofont-rounded-right'></i>"] });
        ...
        $(".ripple-effect, .ripple-playing").ripples({ resolution: 512, dropRadius: 25, perturbance: 0.04 });
        ...
        $(".testimonial-slides").owlCarousel({
            ...
            autoplay: true,
            navText: ["<i class='icofont-rounded-left'></i>", "<i class='icofont-rounded-right'></i>"],
            responsive: { 0: { items: 1 }, 768: { items: 1 }, 1200: { items: 2 } },
        });
        ...
        if (document.getElementById("particles-js-bubble"))
            particlesJS("particles-js-bubble", {
                particles: {
                    number: { value: 120, density: { enable: true, value_area: 800 } },
                    color: { value: "#f2f2f2" },
                    shape: { type: "circle", stroke: { width: 0, color: "#000000" }, polygon: { nb_sides: 5 }, image: { src: "img/github.svg", width: 80, height: 80 } },
                    opacity: { value: 0.5, random: true, anim: { enable: false, speed: 1, opacity_min: 0.1, sync: false } },
                    size: { value: 10, random: true, anim: { enable: false, speed: 40, size_min: 0.1, sync: false } },
                    line_linked: { enable: false, distance: 500, color: "#f2f2f2", opacity: 0.4, width: 2 },
        ...
        if (document.getElementById("particles-js-star"))
            particlesJS("particles-js-star", {
                particles: {
                    ...
                    line_linked: { enable: false, distance: 150, color: "#f2f2f2", opacity: 0.1, width: 1 },
                    move: { enable: true, speed: 14, direction: "right", random: false, straight: true, out_mode: "out", bounce: false, attract: { enable: false, rotateX: 600, rotateY: 1200 } },
                },
                interactivity: {
                    detect_on: "canvas",
        ...
        if (document.getElementById("particles-js-big-bubble"))
            particlesJS("particles-js-big-bubble", {
                particles: {
                    number: { value: 6, density: { enable: true, value_area: 800 } },
                    color: { value: "#1b1e34" },
                    shape: { type: "polygon", stroke: { width: 0, color: "#000000" }, polygon: { nb_sides: 6 }, image: { src: "img/github.svg", width: 10, height: 10 } },
        ...
        if (document.getElementById("particles-js-small-bubble"))
            particlesJS("particles-js-small-bubble", {
                particles: {
